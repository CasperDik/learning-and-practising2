...
class Network(object):
    ...
    def update_mini_batch(self, mini_batch, eta):
        ...
        # So update_mini_batch works simply by computing these gradients for every training example in the mini_batch,
        # and then updating self.weights and self.biases appropriately.

        # nable is the name of the upsidedown triangle denoting the gradient vector
